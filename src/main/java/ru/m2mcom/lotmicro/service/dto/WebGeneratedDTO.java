...
/**
 * A DTO for the WebGenerated entity.
 */
public class WebGeneratedDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        WebGeneratedDTO webGeneratedDTO = (WebGeneratedDTO) o;

        if ( ! Objects.equals(id, webGeneratedDTO.id)) { return false; }
