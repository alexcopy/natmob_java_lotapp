...
/**
 * Performance test for the Hot_plays entity.
 */
class Hot_playsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Hot_plays entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all hot_plays")
            .get("/lotapp/api/hot-plays")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created hot_plays")
                .get("/lotapp${new_hot_plays_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created hot_plays")
            .delete("/lotapp${new_hot_plays_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
